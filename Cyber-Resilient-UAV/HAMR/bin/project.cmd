...
//     sireum proyek run . HAMR.Demo
//
//   To see the available CLI options:
//     sireum proyek run . HAMR.Demo -h
//
//   To run the example unit tests from the command line:
//     sireum proyek test .
//
//   To build an executable jar:
//     sireum proyek assemble --uber --main HAMR.Demo .
//
// Sireum IVE:
//
...
//     Right click src/main/architecture/HAMR/Demo.scala and choose "Run 'Demo'"
//
...
val slangModule: Module = Module(
  id = "MissionComputer_Impl_Instance",
